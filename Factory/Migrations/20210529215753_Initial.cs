        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmploymentStartDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    EngineerMachine = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MachineDescription = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    InstallDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    HoursOperated = table.Column<int>(type: "int", nullable: false),
                    LastInspection = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    InspectionCycle = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true)
                },
                constraints: table =>
                {
